...
namespace ns3
{
                                          ...
                                          double dataSnr, uint16_t dataChannelWidth, uint8_t dataNss)
  {
    ...
    if ( changerate && now >= time1 && this->m_dataMode != WifiMode("HeMcs11"))
    {
      this->m_dataMode = WifiMode("HeMcs11");
      std::cout<<"-------------modify HeMcs11   "<<"\n";
      changerate =false;
      // NS_LOG_UNCOND(this <<  << this->m_dataMode.GetMcsValue() << "\n");
    }
    // if (now >= time2 && this->m_dataMode == WifiMode("HeMcs3"))
    // {
    //   this->m_dataMode = WifiMode("HeMcs11");
    //   std::cout<<"-------------modify HeMcs11   "<<"\n";
    //   // NS_LOG_UNCOND(this << "-------------modify HeMcs11   " << this->m_dataMode.GetMcsValue() << "\n");
    // }
    // std::cout<<now<<"yyq\n";
  }
